...
public class MatrixCalc {
    ...
    public Long[][] performOperation(MatrixOperationWithCheck matrixOperationWithCheck, Matrix matrix1, Matrix matrix2) throws NotConsistentException, DifferentSizesException {
        ...
        FillInArray(matrixOperationWithCheck, matrix1, matrix2, result);
        return result;
    }

    private void FillInArray(MatrixOperationWithCheck matrixOperationWithCheck, Matrix matrix1, Matrix matrix2, Long[][] result) {
